...
function renderModalBody(p) {
  ...
  if (modalTab === 'pips') {
    ...
    body.innerHTML = `
      ...
      <div class="pm-field" style="align-items:flex-start"><span class="pm-field-label" style="padding-top:4px">Plan</span><textarea class="fi" style="min-height:84px;resize:vertical" placeholder="How will this be built? Dax can write this..." onchange="updateFieldModal(${p.id},'plan',this.value)">${esc(p.plan||'')}</textarea></div>
